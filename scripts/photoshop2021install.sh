...
curl -L -P0 "https://web.archive.org/web/20230627155424if_/https://lulucloud.mywire.org/FileHosting/GithubProjects/allredist.tar.xz" > allredist.tar.xz
mkdir allredist
...
curl -L -P0 "https://web.archive.org/web/20230627155425if_/https://lulucloud.mywire.org/FileHosting/GithubProjects/AdobePhotoshop2021.tar.xz" > AdobePhotoshop2021.tar.xz
